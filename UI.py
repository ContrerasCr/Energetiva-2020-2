...
class App(Tk):
    ...
    def add_tab(self):
        tab1 = Main(self.geom)
        tab2 = MejAlimentos(self.geom)
        tab3 = ElegirDieta(self.geom)
        tab4 = Geometrica(self.geom)
        tab5 = BinomialNegativa(self.geom)

        self.notebook.add(tab1, text='Main')
        self.notebook.add(tab2, text='Mejores Alimentos')
        self.notebook.add(tab3, text='Crear una dieta')
        self.notebook.add(tab4, text='Costo Acueducto')
        self.notebook.add(tab5, text='Costos totales')
...
class ElegirDieta(Frame):
    def __init__(self, geom):
        ...
        # Column 0
        Entry(self, width=2, textvariable=self.var_nuez).place(x=20, y=90)
        Entry(self, width=2, textvariable=self.var_almendra).place(x=20, y=120)
        Entry(self, width=2, textvariable=self.var_palta).place(x=20, y=150)
        Entry(self, width=2, textvariable=self.var_papa).place(x=20, y=180)
        Entry(self, width=2, textvariable=self.var_pimiento_rojo).place(x=20, y=210)
        ...
        # Column 1
        Entry(self, width=2, textvariable=self.var_almendra).place(x=150, y=90)
        Entry(self, width=2, textvariable=self.var_nuez).place(x=150, y=120)
        Entry(self, width=2, textvariable=self.var_lechuga).place(x=150, y=150)
        Entry(self, width=2, textvariable=self.var_pimiento_rojo).place(x=150, y=180)
        Entry(self, width=2, textvariable=self.var_espinaca).place(x=150, y=210)
        ...
        # Column 2
        Entry(self, width=2, textvariable=self.var_papa).place(x=280, y=90)
        Entry(self, width=2, textvariable=self.var_pimiento_rojo).place(x=280, y=120)
        Entry(self, width=2, textvariable=self.var_damasco).place(x=280, y=150)
        Entry(self, width=2, textvariable=self.var_zapallo_cocido).place(x=280, y=180)
        Entry(self, width=2, textvariable=self.var_guayaba).place(x=280, y=210)
        ...
        # Column 3
        Entry(self, width=2, textvariable=self.var_almendra).place(x=410, y=90)
        Entry(self, width=2, textvariable=self.var_espinaca).place(x=410, y=120)
        Entry(self, width=2, textvariable=self.var_lechuga).place(x=410, y=150)
        Entry(self, width=2, textvariable=self.var_repollo).place(x=410, y=180)
        Entry(self, width=2, textvariable=self.var_nuez).place(x=410, y=210)
        ...
        # Column 4
        Entry(self, width=2, textvariable=self.var_espinaca).place(x=540, y=90)
        Entry(self, width=2, textvariable=self.var_lechuga).place(x=540, y=120)
        Entry(self, width=2, textvariable=self.var_almendra).place(x=540, y=150)
        Entry(self, width=2, textvariable=self.var_nuez).place(x=540, y=180)
        Entry(self, width=2, textvariable=self.var_pimiento_verde).place(x=540, y=210)
        ...
        # Column 5
        Entry(self, width=2, textvariable=self.var_pimiento_rojo).place(x=670, y=90)
        Entry(self, width=2, textvariable=self.var_zapallo_cocido).place(x=670, y=120)
        Entry(self, width=2, textvariable=self.var_espinaca).place(x=670, y=150)
        Entry(self, width=2, textvariable=self.var_zanahoria).place(x=670, y=180)
        Entry(self, width=2, textvariable=self.var_lechuga).place(x=670, y=210)
        ...
        # Column 6
        Entry(self, width=2, textvariable=self.var_pimiento_rojo).place(x=800, y=90)
        Entry(self, width=2, textvariable=self.var_pimiento_verde).place(x=800, y=120)
        Entry(self, width=2, textvariable=self.var_guayaba).place(x=800, y=150)
        Entry(self, width=2, textvariable=self.var_repollo).place(x=800, y=180)
        Entry(self, width=2, textvariable=self.var_coliflor_cocida).place(x=800, y=210)
